...
- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame rectColor:(UIColor *)rectColor {
    ...
    if (self) {
        ...
        _torchSwithButton.frame = CGRectMake(.0, .0, 120.0, 70.0);
        ...
        [_torchSwithButton setTitle:@"Tap to turn light on" forState:UIControlStateNormal];
        [_torchSwithButton setTitle:@"Tap to turn light on" forState:UIControlStateSelected];
        ...
        _tipsLabel.text = @"Align QR code within frame to scan";
